		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="block-body">
					<?php echo $this->Form->create('Cliente', array('action'=>'add', 'class'=>'wizard form-horizontal', 'data-validate'=>'parsley')); ?>
						...
						<span id="validate-basic-form-valid" onclick="javascript:$('#validate-basic-form').parsley('validate');">
							<?php echo $this->Form->submit('Crear nuevo cliente', array('class'=>'btn btn-primary', 'div'=>false)); ?>
						</span>
